...
class Logger():
    ...
    def __init__(self, continue_logging, logging_directory):
        ...
        self.mask_rg_directory = os.path.join(self.base_directory, 'mask-rg')
        self.mask_images_directory = os.path.join(self.base_directory, 'mask-rg', 'prediction-images')
    ...
    def save_mask_diff_image(self, maskdiff, iteration, session_iteration, err_rate):
