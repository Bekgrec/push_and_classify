...
class Robot(object):
    ...
    def restart_sim(self):
        ...
        time.sleep(1) # this gives enough time to Vrep to reset object dynamics in the simulation so that mask-rg can get the depth at the zeroth iteration!
    ...
    # TODO is this really necessary -> there is no grasping at the moment
    ...
    def push(self, position, heightmap_rotation_angle, workspace_limits):
        ...
        # Compute gripper position and linear movement increments #TODO Why did he change the variable name here,it's non-sense
