...
class MaskRGNetwork(nn.Module):
    ...
    # def get_maskrcnn_model(self):
    #     return self.mask_r_cnn

    #if __name__=="__main__":

        #img = cv2.imread("/media/baris/Data/Random_Heap_Database_v2/depth_ims/depth_thresholded/image_000000.png")
        #img = Image.open("/media/baris/Data/Database_v0.2/color_ims/image_000000.png")
        #img = Image.open("/home/baris/Stuff/peppers.png")
        #asd = TestNetwork(is_cuda=False)
        #preds = asd.forward(img)
        # print(preds)
